...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield page.waitForSelector('#container > #login_form #login');
    yield page.click('#container > #login_form #login');
    yield page.waitForSelector('#container > #login_form #login');
    yield page.click('#container > #login_form #login');
    yield page.type('#container > #login_form #login', 'darrodri');
    yield page.waitForSelector('#login_form > .login-form > div > .text-right > .button');
    yield page.click('#login_form > .login-form > div > .text-right > .button');
    yield navigationPromise;
